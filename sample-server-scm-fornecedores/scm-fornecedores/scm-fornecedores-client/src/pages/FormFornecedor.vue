    ...
    <q-card class="card-insert-form">
      ...
      <q-card-section class="items-center">
        <q-tabs v-model="tabFornecedores">
          ...
          <q-tab label="Fornecíveis" name="tab-forneciveis" icon="local_shipping"/>
        </q-tabs>
        <q-separator/>
        <q-tab-panels v-model="tabFornecedores" animated keep-alive>
          ...
          <q-tab-panel name="tab-endereco">
            ...
            <q-card-section class="row">
              <q-select
                outlined
                class="col-md-6 q-pa-md"
                v-model="fornecedor.endereco.tipoEndereco"
              ...
              <q-select
                outlined
                class="col-md-6 q-pa-md"
                v-model="fornecedor.endereco.tipoLogradouro"
            ...
            <q-card-section v-for="contato in fornecedor.contatos" :key="contato.index">
              ...
              <q-card-section class="row">
                ...
                <q-select
                  ...
                  v-model="contato.telefone.tipoTelefone"
          ...
          <q-tab-panel name="tab-forneciveis">
            aba fornecíveis
          </q-tab-panel>
        </q-tab-panels>
      </q-card-section>
...
export default defineComponent({
  ...
  methods: {
    ...
    createForneciveisCombobox (val) {
      this.fetchForneciveisByTipo(val)
    },
    allowEnderecoFields () {
    ...
    fetchForneciveisByTipo (tipoFornecivel) {
      this.$axios.get('http://localhost:9999/api/fornecivel/', { params: { tipo: tipoFornecivel } })
        .then((res) => {
          this.comboForneciveis = res.data
        })
    }
  }
})
